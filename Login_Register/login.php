...
print '<h2>Login Form</h2><p>Users who are logged in can take 
advantage of certain feature like this, that, and the other thing.</p>';
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if ( (!empty($_POST['email'])) && (!empty($_POST['password'])) ) {
		...
		size="20"></p><p><label for="password">Password:</label><input type="password"
